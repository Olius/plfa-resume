...
% Vic: On définit avec des \enquote{\_}
% pour écrire \verb|a + b| au lieu d'écrire \verb|_+_ a b| ?
Encore bonjour.
Voici du code;
...
Il s'agit d'une preuve que \(3 + 4 = 7\),
écrit en Agda comme \verb|3 + 4 ≡ 7|.
Chaque proposition en Agda est un type,
et une preuve de cette proposition est un élément du type.
Ici on dit que notre preuve sera de (type) \verb|3 + 4 ≡ 7|,
et on la définit à la deuxième ligne par la chaîne d'égalités.
On reviendra plus tard sur le symbole \verb|≡⟨⟩|.
